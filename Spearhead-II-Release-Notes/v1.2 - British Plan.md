...
- Free French
  - Hammer
    ...
    - Defence of la Patrie - Infiltration of militia behind enemy lines is now possible.
  - Anvil
...
- Mechanised
  ...
  - Anvil
    - Expert Maintenance - All infantry sections can perform rudimentary repair on vehicles.
    - Efficient War Machine - Light vehicles no longer cost fuel to build.
- Guard
  - Hammer
...
- Special Operations
  - Hammer
    ...
    - Vickers K HMG Replacement - Replaces the standard .303 Vickers Heavy Machine Gun with the Vickers K Heavy Machine Gun.
  - Anvil
