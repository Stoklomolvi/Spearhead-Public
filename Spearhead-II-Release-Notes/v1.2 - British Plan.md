...
- Tier 1 - Support Command Post
  ...
  - Row 2
    ...
    - 23 - Halftrack requisition, M3 Halftrack
    - 24 - Doctrinal halftrack/light vehicle
      - Airborne/Artillery/Free French - M3A1 scout car
      - Guard/Tank/Mechanised - AEC armoured car
  - Row 3
    - 31 - Light tank requisition, Stuart light tank
    - 32 - Doctrinal light tank
      - Airborne/Artillery/Free French - M8 Greyhound
      - Guard/Tank/Mechanised - Valentine light tank
    - 33 - Logistics requisition, GMC CCKW truck
    - 34 - Anti-aircraft requisition, M15A1 anti-aircraft halftrack
      - Airborne/Free French - M16 anti-aircraft halftrack
- Tier 2 - Vehicle Command Post
  - Row 1
    ...
    - 13 - Support tank requisition, Doctrinal support tank
      - Airborne - Cromwell VI (95mm howitzer)
    ...
    - 14 - Tank destroyer requisition, Doctrinal tank destroyer
      - Tank/Mechanised - Comet tank
      - Others - Sherman Firefly
  - Row 2
  ...
  - Row 3
    - 31 - Artillery requisition (requires Advanced technology requisition), Doctrinal self-propelled artillery
      - Airborne/Artillery - Sexton 25-pounder self-propelled gun
      - Priest - Free French
...
- Tier 3 - Research Command Post
  ...
  - Hammer
    ...
    - (Common) Medium tank specific upgrade
      ...
      - Sherman V tank receives free pintle .50 MGs (locks out tank commander)
    - (Common) Global sight and reconnaissance increases for all infantry
    - (Common) Tank destroyer upgrade
      - Sherman Firefly main gun penetration upgrade (AP -> APCBC)
